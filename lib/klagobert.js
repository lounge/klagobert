...
Klagobert.prototype._positiveScore = function(username, bitterPoints, msg) {
  var isPositiveHack = this.tools.checkPositiveHack(username, msg);
console.log('isPositiveHack: ' + isPositiveHack);
  if (!isPositiveHack) {
...
Klagobert.prototype.sendMessage = function(msg, data) {
