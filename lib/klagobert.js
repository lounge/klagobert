...
var twilio = require('twilio')('ACdf68dd4bda820a507c05bf5c4ea7dd24', '0baebd50ef72a703d6224eeb1e330757');
...
class Klagobert extends Bot {
  ...
  _containsKau(msgContent) {
    console.log('_containsKau()');
    var self = this;
    var m = msgContent.toLowerCase();
    if (m.indexOf('kaulanen') > -1 || m.indexOf('kau') > -1) {
      console.log('match kau!');

      this.messages.kau(function(msg, command) {
        console.log('send kau ' + 'command: ' + command + ' msg: ' + msg);
  ...
  postCommandToChannel(id, text, command, params) {
      ...
      console.log('postCommandToChannel() ' + 'id: ' + id + ' command: ' + command + ' text: ' + text +  ' params: ' + params);
